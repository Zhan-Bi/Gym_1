...
$mail->Password = "LDsa*9$02Ida&"; // Ваш пароль от почты с которой будут отправляться письма
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465; // TCP port to connect to / этот порт может отличаться у других провайдеров

$mail->setFrom("nekozhanyymeshok@mail.ru"); // от кого будет уходить письмо?
$mail->addAddress("kar.one.to.one@gmail.com", "Kar[1]");     // Кому будет уходить письмо
